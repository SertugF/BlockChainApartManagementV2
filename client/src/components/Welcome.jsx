...
//const Input = ({ placeholder }) => <input placeholder={placeholder}></input>;
const Input = ({ placeholder, name, type, handleChange, value }) => (
  <input
    ...
    className="my-2 w-full p-2 rounded-sm bg-transparent outline-none text-white border-none text-sm white-glassmorphism"
  />
);
      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          ...
          <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
            ...
            {/* İf screen isloading do first else activate button which can be used to submit*/}
            {false ? (
              <Loader />
            ) : (
              <button
